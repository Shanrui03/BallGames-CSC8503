...
namespace NCL {
	...
	public:
		...
		static float InigoCapsule(Vector3 rayOrigin, Vector3 RayDirection, Vector3 pa, Vector3 pb, float radius);
		...
		static bool OBBSphereIntersection(const OBBVolume& volumeA, const Transform& worldTransformA, const SphereVolume& volumeB, 
		...
		static bool AABBCapsuleIntersection(const CapsuleVolume& volumeA, const Transform& worldTransformA,
			const AABBVolume& volumeB, const Transform& worldTransformB, CollisionInfo& collisionInfo);
		static bool OBBCapsuleIntersection(const OBBVolume& volumeB, const Transform& worldTransformB,
		...
		static Vector3      ClosestPointOnLine(const Vector3& capsuleBase, const Vector3& capsuleTip, const Vector3& point);
